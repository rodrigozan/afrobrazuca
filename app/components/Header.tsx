...
const Header: React.FC = () => {
  return (
    <header className={styles.header}> 
      <h1 className='text-primary'>Afrobrazuca</h1>
      <p>
        <a href="https://open.spotify.com/intl-pt/artist/2vQYZkXsLPj0QALQaSINWr" className="btn btn-success m-2 text-white"> <img src={spotify.src} /> Ouça no Spotify</a>
